//Control LED Matrix by web sever : NodeMcu Esp8266
#include <LEDMatrixDriver.hpp>
#include <ESP8266WiFi.h>
#include <WiFiClient.h>

const char* ssid = "running text";  // your Wifi
const char* password = "12345678"; // passe Word
// TCP server at port 80 will respond to HTTP requests
WiFiServer server(80);
const uint8_t LEDMATRIX_CS_PIN = D8;

// Define LED Matrix dimensions (0-n) - eg: 32x8 = 31x7
const int LEDMATRIX_WIDTH = 15;     // 31 or 63 or 15
const int LEDMATRIX_HEIGHT = 7;   // 7
const int LEDMATRIX_SEGMENTS = 2;  //  2 or 4 or 8
...
// Marquee text
char text[75] = " Wellcome To LILY.OSP running text box ";
int len = strlen(text);
// Marquee speed
const int ANIM_DELAY = 73;
...
void loop()
{
  ...
  else
  {
    ...
    s = "HTTP/1.1 200 OK\r\nContent-Type: text/html\r\n\r\n";
    s += "<!doctype html> <style> \#header{ min-height: 20px; background-color: \#666699; } \#menu{ min-height: 20px; margin-top: 1%; background-color: \#999999; } \#body{ min-height: 200px; margin-top: 1%; } \#footer{ min-height: 20px; margin-top: 1%; background-color: \#666699; } \#header, \#menu, \#body, \#footer{ margin-left: 10%; margin-right: 10%; box-shadow: 3px 5px 7px \#666666; border: 1px solid black; } @viewport{ zoom: 1.0; width: extend-to-zoom; } @-ms-viewport{ width: extend-to-zoom; zoom: 1.0; } </style> <html lang='en'> <head> <meta name='viewport' content='width=device-width, initial-scale=1'> <title>running text web setup</title> </head> <body> <div id='header'><center><h1>lily running text</H1></center></div> <div id='menu'><center><H2>Enter text which will be displayed on  LED Matrix</h2></center></div> <div id='body'><center><div><div><br> <form action='esp8266'> <br>Enter Text to display on LED Matrix:<br><input type='text' maxlength='70' name='max' value=''><br><br> <input type='submit' value='Submit'></form> </div></div> </center> </div> <div id='footer'> </div> </body>";
    s += "</html>\r\n\r\n";
    client.print(s);
    return;
  }
